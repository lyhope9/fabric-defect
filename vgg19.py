...
class Vgg19:
    ...
    def build(self, rgb, size = 256):
        ...
        #self.conv_list.append(self.conv2_1) #self.conv_list.append(self.pool1)
        ...
        #self.conv_list.append(self.conv3_1) #self.conv_list.append(self.pool2)
        ...
        #self.conv_list.append(self.conv4_1) #self.conv_list.append(self.pool3)
        ...
        #self.conv_list.append(self.conv5_1) #self.conv_list.append(self.pool4)
